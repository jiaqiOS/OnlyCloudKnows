...
The Latin origin of the term data is the plural form of datum, meaning "(thing) given."  Art, however, is never given as merely the thing. Only Cloud Knows, a Chrome extension that detects and evaluates images containing "art," as perceived through the lens of Google Cloud Vision AI, manifests how this emerging regime captures the incalculable and unknown in computationally legible form—the confidence labels returned from Vision API overlay over images as Web page loads. By operating within the wrong-headed perception of the industrial AI model, Only Cloud Knows invites users to inquire into the biases and limits of machine intelligence programmed to see and foresee: what lies beneath its threshold of recognizability? What is excluded from future possibilities? With this project, I aim to mirror how thoughtless belief in the technical sightline has clouded our vision and short-circuited our sensory-noetic loop without detection.
